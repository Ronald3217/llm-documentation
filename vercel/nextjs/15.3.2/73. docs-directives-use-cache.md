...
This means `use cache` cannot be used with [request-time APIs](about:/docs/app/getting-started/partial-prerendering#dynamic-rendering) like `cookies` or `headers`.
