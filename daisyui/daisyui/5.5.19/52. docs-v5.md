...
daisyUI, the essential [component library](/pages/css-library-for-html/ "CSS Library for HTML") for Tailwind CSS is now being used in [360,000 open source projects](https://github.com/saadeghi/daisyui/network/dependents), with 19 million npm installs (350 thousand weekly installs). daisyUI is growing faster than before and today it's helping many people, startups and companies to create improve their development experience.
...
daisyUI 5 has [no dependencies](/pages/minimal-css-framework/ "daisyUI is a minimal CSS framework"). Hopefully this helps to clean up your node\_modules a little bit.
