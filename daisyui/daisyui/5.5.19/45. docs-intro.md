...
Yes! It's [utility-first](/pages/tailwind-css/), not utility-only.
...
ALL of them! daisyUI is [framework agnostic](/pages/css-library-for-html/). You can use it anywhere you can use CSS.
