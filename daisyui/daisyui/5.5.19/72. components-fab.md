...
| --------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| fab             | Component |                                                                                                                                       |
| fab-close       | Part      | Optional class for a close button (or a wrapper of a close button)                                                                    |
| fab-main-action | Part      | Optional class for the main action button (or a wrapper of the main action button). Either use fab-close or fab-main-action, not both |
| fab-flower      | Modifier  | Modifier class for fab to make it open in a quarter circle arrangement instead of vertical                                            |
