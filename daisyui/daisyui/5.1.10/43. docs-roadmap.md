...
*   * * *
    ...
    1.  Floating action button / Speed Dial
    2.  Styled native HTML <select> options
    3.  Hover Gallery
    4.  Mega menu
    5.  Pre-built CSS grid layouts
    6.  micro animations
    7.  More theme effects
    8.  CSS anchor positioning
    9.  View transitions API
    10.  CSS color-contrast()
    11.  CSS relative color syntax
    12.  CSS animation timeline
    13.  HTML invoker API
    14.  Tailwind CSS 5
    15.  CSS @scope
